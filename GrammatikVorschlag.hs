...
Expression4 ::= Epression5 | "(" Expression5 ComparisonOperator Expression5 ")" | "(" Expression5 ComparisonOperator | ComparisonOperator Expression5 ")"
Expression5 ::= Expression6 RestExpression5
RestExpression5 ::= {"+" Expression6 } | "(" "-" Expression6 | "-" Expression6 | "-" Expression6 ")"
Expression6 ::= Expression7 | "(" "-" Expression7 | "-" Expression7 | "-" Expression7 ")"
